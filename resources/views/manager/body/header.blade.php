<header>
        ...
        $profileData = App\Models\User::find($id);
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ (!empty($profileData->photo)) ? url('upload/manager_images/'.$profileData->photo) : url('upload/no_image.jpg')}}" class="user-img" alt="user avatar">
                    <div class="user-info">
  ...
  <li><a class="dropdown-item d-flex align-items-center" href="{{ route('manager.profile') }}"><i class="bx bx-user fs-5"></i><span>Profile</span></a>
    ...
    <li><a class="dropdown-item d-flex align-items-center" href="{{ route('manager.logout') }}"><i class="bx bx-log-out-circle"></i><span>Logout</span></a>
    </li>
                </ul>
            </div>
        </nav>
