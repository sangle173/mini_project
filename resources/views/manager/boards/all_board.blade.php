...
@section('users')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">All Boards</div>
            <div class="ps-3">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                               href="{{ route('manager.all.boardteams', $item -> id) }}">Manage Team</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                               href="{{ route('manager.all.boardtypes', $item -> id) }}">Manage Type</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                        ...
                                        <li>
                                            <a class="dropdown-item"
                                               href="{{ route('manager.all.tasks', $item -> id) }}">Manage Task</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                               href="{{ route('manager.config.board', $item -> id) }}">Board Config</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
