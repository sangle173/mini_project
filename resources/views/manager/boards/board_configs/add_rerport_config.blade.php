...
@section('users')
    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Report Config</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <form id="myForm" action="{{ route('manager.save-report-config') }}" method="post" class="row g-3"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <label for="jira_url" class="col-sm-3 col-form-label">Subject</label>
                            <div class="col-sm-9">
                                <div class="col-sm-9">
                                    <div class="position-relative input-icon">
                        ...
                        <div class="row mb-3">
                            <label for="jira_url" class="col-sm-3 col-form-label">CC List</label>
                            <div class="col-sm-9">
                                <div class="col-sm-9">
                                    <div class="position-relative input-icon">
                                        <input type="text" class="form-control"
