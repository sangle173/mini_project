...
@section('users')
    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Env</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <form id="myForm" action="{{ route('manager.update.env') }}" method="post" class="row g-3"
                      enctype="multipart/form-data">
                    @csrf

                    <div class="card-body">
                        <h5 class="mb-4">Edit Env - <span class="text-danger">Please enter with format item1;item2;item3...</span></h5>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="email" id="email" rows="3"
                                          placeholder="Enter email list ...">{{$env -> email}}</textarea>
                                @error('email')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="browser" id="browser" rows="3"
                                          placeholder="Enter browser list ...">{{$env -> browser}}</textarea>
                                @error('browser')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="player" id="player" rows="3"
                                          placeholder="Enter player list ...">{{$env -> player}}</textarea>
                                @error('player')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="drop_date" id="drop_date" rows="3"
                                          placeholder="Enter drop date ...">{{$env -> drop_date}}</textarea>
                                @error('drop_date')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="build" id="build" rows="3"
                                          placeholder="Enter build list ...">{{$env -> build}}</textarea>
                                @error('build')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" name="device" id="device" rows="3"
                                          placeholder="Enter device list ...">{{$env -> device}}</textarea>
                                @error('device')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
