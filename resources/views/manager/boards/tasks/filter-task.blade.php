                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" id="submitButton" onclick="disableButton(this)"
            ...
            <form method="GET" action="{{ route('tasks.filter', $board -> id) }}" class="row g-3 mb-4">
                ...
                <div class="col-md-2">
                    <select name="type" class="form-select">
                        ...
                        @foreach ($types as $type)
                            <option
                                value="{{ $type->id }}" {{ ($filters['type'] ?? '') == $type->id ? 'selected' : '' }}>
                                {{ $type->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-2">
                    <select name="team" class="form-select">
                        ...
                        @foreach ($teams as $team)
                            <option
                                value="{{ $team->id }}" {{ ($filters['team'] ?? '') == $team->id ? 'selected' : '' }}>
                                {{ $team->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-md-2 ms-auto">
                    ...
                    <!-- Reset Filters -->
                    <a href="{{ route('tasks.filter', $board -> id) }}" class="btn btn-secondary">Reset</a>
                </div>
            </form>
