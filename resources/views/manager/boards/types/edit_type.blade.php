...
@section('users')
    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                <form id="myForm" action="{{ route('manager.update-boardtype') }}" method="post" class="row g-3"
                      enctype="multipart/form-data">
                    @csrf

                    <div class="card-body">
                        <h5 class="mb-4">Edit Type</h5>
                        <input type="hidden" name="team_id" value="{{$type-> id}}">
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <div class="position-relative input-icon">
                                    <input type="text" class="form-control" name="desc" value="{{$type -> desc}}" id="desc"
